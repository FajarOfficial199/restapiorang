document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "RELL UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 RELL. All rights reserved.");
        setContent('header', 'textContent', settings.name || "RELL UI");
        setContent('name', 'textContent', settings.name || "RELL UI");
